...
params:
  ...
  portfolioName:
    input: text
    label: title
    value: "Balanced Portfolio Returns"
  window:
    input: numeric
...
render_connect_email(input = "portfolio-report-email.Rmd", connect_footer = FALSE) %>%
  attach_connect_email(
    subject = sprintf("Update on %s",params$portfolioName),
    attach_output = TRUE,
